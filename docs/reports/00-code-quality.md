...
| P2-5 | ✅ **DONE** | ~~Duplicate Jest config~~ | — | Jest is gone; one `vitest.config.mts` is the single source of truth. See report 01. | — | — |
...
- **A real regression net exists, and it more than doubled this refresh.** **1709 tests**
  ...
  `vitest.config.mts` fail CI on regression, and #880 closed the more dangerous failure
