...
import SchemasStacksView from '../keep-schemas-stacks-view';
 ...
 */
export const KeepSchemasStacksView = createComponent({
  tagName: 'keep-schemas-stacks-view',
  elementClass: SchemasStacksView,
  react: React,
  events: {
