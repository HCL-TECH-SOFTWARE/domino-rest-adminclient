  ...
  static styles = [
    ...
    css`
      ...
      *::after {
      ...
      /*
       * was .remove-field-warning-icon.p-0.flex.items-center. The glyph itself is inline
       * because the bundled icon set has no exclamation mark; #d6466f is the colour the
       * original graphic was drawn with, moved out of the markup so there is one copy.
       */
      .warning-icon {
        display: flex;
        align-items: center;
      ...
      <dialog aria-label="Remove Field" @cancel=${this.closeRemoveDialog}>
        <div class="dialog-head">
          <div class="warning-icon">
            <!-- The clip path the original wrapped this in covered the whole 35x35 canvas,
                 so it clipped nothing and is dropped with its defs block. -->
            <svg
