...
class SourceContents extends LitElement {
  static styles = css`
    ...
    header {
        background-color: var(--theme-bg-header);
        border-top: 1px solid var(--theme-border-heavy);
        border-left: 1px solid var(--theme-border-heavy);
        border-right: 1px solid var(--theme-border-heavy);
        color: var(--theme-text);
        ...
        <header>
            ...
            <section class="buttons-container">
                <section style="display: flex; flex-direction: row; align-items: center; gap: 13px;">
                    <button title="Copy" style="color: var(--theme-text-secondary);" @click="${this.handleCopyClick}"><sl-icon src="${IMG_DIR}/shoelace/copy.svg"></sl-icon></button>
                    <button title="Download" style="color: var(--theme-text-secondary);" @click="${this.handleDownloadClick}"><sl-icon src="${IMG_DIR}/shoelace/download.svg"></sl-icon></button>
                </section>
                <section style="display: flex; flex-direction: row; align-items: center; gap: 13px;">
                    <section>
