...
import '../../../src/components/keep-elements/keep-button-yes';
import type ButtonYes from '../../../src/components/keep-elements/keep-button-yes';

const TAG = 'keep-button-yes';

const innerButton = (el: ButtonYes) => el.shadowRoot!.querySelector('button')!;

describe('keep-button-yes', () => {
