...
import '../../../src/components/lit-elements/lit-source';
import type SourceTree from '../../../src/components/lit-elements/lit-source';
...
describe('lit-source-tree (SourceTree)', () => {
