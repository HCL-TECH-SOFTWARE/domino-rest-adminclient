...
import '../../../src/components/lit-elements/lit-button-no';
import type ButtonNo from '../../../src/components/lit-elements/lit-button-no';

const TAG = 'lit-button-no';

const innerButton = (el: ButtonNo) => el.shadowRoot!.querySelector('button')!;

describe('lit-button-no', () => {
