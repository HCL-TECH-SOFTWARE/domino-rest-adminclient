...
import '../../../src/components/lit-elements/lit-input-password';
import type InputPassword from '../../../src/components/lit-elements/lit-input-password';

const TAG = 'lit-input-password';

const waInput = (el: InputPassword) => el.shadowRoot!.querySelector('wa-input')!;

describe('lit-input-password', () => {
