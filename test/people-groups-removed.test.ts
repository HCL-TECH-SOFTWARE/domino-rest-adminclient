 ...
 *   - `sidenav/SideNav.tsx`    the `navitems.users` / `navitems.groups` link blocks
...
describe('People and Groups stay removed (#770)', () => {
  ...
  it('offers no navigation entry that leads nowhere', () => {
    ...
    for (const file of ['src/components/sidenav/SideNav.tsx', 'src/components/home/sections/Section.tsx']) {
